    ...
    <div class="logo-responsivoAlt">
        ...
        <div class="contenedor-registro sombraOpacidad cr-login">
            ...
            <form class="formulario" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <br>
                <div class="center">
                    <p class="login-text">¿No tienes una cuenta en BandUp? <a class="link" href="register">Regístrate ahora</a>.</p>
        </div>
            </form>
        ...
        <div class="img-registro res menor">
            <img class="side res" src="/img/alt/side-registro-<?php echo rand(1, 8); ?>.png" alt="Registro" />
        </div>
        ...
        <div class="noRes contenedor-registro cr-login">
            ...
            <form class="formulario" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <br>
                <p>¿No tienes una cuenta en BandUp? <a class="link" href="register">Regístrate ahora</a>.</p>
            </form>
        </div>

        <div class="img-registro noRes">
            <img class="side noRes" src="side-registro-<?php echo rand(1, 12); ?>.png" alt="Registro" />
        </div>
    </body>
