...
<body>
    ...
    <main id="contPro" class="contenedor-producto sombra">
                <?php
                $query = $link->query("SELECT * FROM productos WHERE id = $id");
                if($query->num_rows > 0){ 
...
<div class="row">
        <div id="content" class="col-lg-12">
            <form action="#" method="post">
                ...
                <div class="alert alert-success" style="display: none;">¡Gracias por tus comentarios! El rating enviado fue de <span id="rate"></span> estrellas.</div>
                <br>
...
<script lenguage="javascript">    
    ...
    var cont = document.getElementById('contPro');
