...
<html lang='es'>
    ...
    <path fill="currentColor" d="M14 20H4V17C4 14.3 9.3 13 12 13C13.5 13 15.9 13.4 17.7 14.3C16.9 14.6 16.3 15 15.7 15.5C14.6 15.1 13.3 14.9 12 14.9C9 14.9 5.9 16.4 5.9 17V18.1H14.2C14.1 18.5 14 19 14 19.5V20M23 19.5C23 21.4 21.4 23 19.5 23S16 21.4 16 19.5 17.6 16 19.5 16 23 17.6 23 19.5M12 6C13.1 6 14 6.9 14 8S13.1 10 12 10 10 9.1 10 8 10.9 6 12 6M12 4C9.8 4 8 5.8 8 8S9.8 12 12 12 16 10.2 16 8 14.2 4 12 4Z" />
                    ...
                    <div class="campo-ayuda reg"><?php echo $nombre_err; ?></div>
                </div>
                <div class="solo">
                <svg class="iconReg" style="width:24px;height:24px" viewBox="0 0 24 24">
    <path fill="currentColor" d="M11,4A4,4 0 0,1 15,8A4,4 0 0,1 11,12A4,4 0 0,1 7,8A4,4 0 0,1 11,4M11,6A2,2 0 0,0 9,8A2,2 0 0,0 11,10A2,2 0 0,0 13,8A2,2 0 0,0 11,6M11,13C12.1,13 13.66,13.23 15.11,13.69C14.5,14.07 14,14.6 13.61,15.23C12.79,15.03 11.89,14.9 11,14.9C8.03,14.9 4.9,16.36 4.9,17V18.1H13.04C13.13,18.8 13.38,19.44 13.76,20H3V17C3,14.34 8.33,13 11,13M18.5,10H20L22,10V12H20V17.5A2.5,2.5 0 0,1 17.5,20A2.5,2.5 0 0,1 15,17.5A2.5,2.5 0 0,1 17.5,15C17.86,15 18.19,15.07 18.5,15.21V10Z" />
                    ...
                    <input id="username" name="username" value="<?php echo $username; ?>" type="text" placeholder="Nombre de usuario"  title=""/>
                    <div class="campo-ayuda reg"><?php echo $username_err; ?></div>
                </div>
                <div class="solo">
                <svg class="iconReg" style="width:22px; height:22px" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M22 6C22 4.9 21.1 4 20 4H4C2.9 4 2 4.9 2 6V18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6M20 6L12 11L4 6H20M20 18H4V8L12 13L20 8V18Z" />
                </svg>
                    <input id="email" name="email" value="<?php echo $email; ?>" type="text" placeholder="Correo electronico"/>
                    <div class="campo-ayuda reg"><?php echo $email_err; ?></div>
                </div>
                <div class="varios">
                <svg class="iconReg" style="width:22px; height:22px" viewBox="0 0 24 24">
    <path fill="currentColor" d="M12,17C10.89,17 10,16.1 10,15C10,13.89 10.89,13 12,13A2,2 0 0,1 14,15A2,2 0 0,1 12,17M18,20V10H6V20H18M18,8A2,2 0 0,1 20,10V20A2,2 0 0,1 18,22H6C4.89,22 4,21.1 4,20V10C4,8.89 4.89,8 6,8H7V6A5,5 0 0,1 12,1A5,5 0 0,1 17,6V8H18M12,3A3,3 0 0,0 9,6V8H15V6A3,3 0 0,0 12,3Z" />
                    ...
                    <input id="password" name="password" type="password" placeholder="Contraseña" value="<?php echo $password; ?>" minlength="8"  title="At least 1 Uppercase
...
Min 8 chars and Max 12 chars"/>
                    ...
                    <div class="campo-ayuda reg"><?php echo $password_err; ?></div>
        </div>
                <div class="center">
                    <input type="checkbox" class="padding" value="1" name="terminos" checked required /><label class="terminos" for="terminos">He leído y acepto los <a class="link" href="terminos-y-condiciones">términos y condiciones</a> y el <a class="link" href="aviso-de-privacidad">aviso de privacidad</a>.</label>
        </div>
                    <div class="center">
                    <button onclick="validarCorreo(document.getElementById('email').value)
                                    validarUsuario(document.getElementById('username').value)
                                    validarContra(document.getElementById('password').value)" type="submit" class="registro" name="enviar" >Crear una cuenta</button>
                </div>
                <br>
                <p class="login-text">¿Ya tienes una cuenta en BandUp? <a class="link" href="login.php">Inicia sesión</a>.</p>
            </form>
        ...
        <div class="img-registro res">
            <img class="side res <?php echo htmlspecialchars($style_err2); ?>" src="/img/alt/side-registro-<?php echo rand(1, 8); ?>.png" alt="Registro" />
        </div>
    ...
    <path fill="currentColor" d="M11,4A4,4 0 0,1 15,8A4,4 0 0,1 11,12A4,4 0 0,1 7,8A4,4 0 0,1 11,4M11,6A2,2 0 0,0 9,8A2,2 0 0,0 11,10A2,2 0 0,0 13,8A2,2 0 0,0 11,6M11,13C12.1,13 13.66,13.23 15.11,13.69C14.5,14.07 14,14.6 13.61,15.23C12.79,15.03 11.89,14.9 11,14.9C8.03,14.9 4.9,16.36 4.9,17V18.1H13.04C13.13,18.8 13.38,19.44 13.76,20H3V17C3,14.34 8.33,13 11,13M18.5,10H20L22,10V12H20V17.5A2.5,2.5 0 0,1 17.5,20A2.5,2.5 0 0,1 15,17.5A2.5,2.5 0 0,1 17.5,15C17.86,15 18.19,15.07 18.5,15.21V10Z" />
                ...
                <svg class="iconReg" style="width:22px; height:22px" viewBox="0 0 24 24">
                    ...
                    <input id="email" name="email" value="<?php echo $email; ?>" type="email" placeholder="Correo electronico"/>
                    <div class="campo-ayuda reg"><?php echo $email_err; ?></div>
                </div>
                <div class="varios">
                <svg class="iconReg" style="width:22px; height:22px" viewBox="0 0 24 24">
