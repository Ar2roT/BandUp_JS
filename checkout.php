...
<body>
    <main class="contenedor sombra">
        <a class="titulos-body alt">Checkout</a>
        <div class="checkout">
        <a class="titulos-body alt2">Resumen del artículo</a>
        <br>
            <hr noshade color="#dc454d">
        <table class="table">
            <hr>
            <thead>
                <tr>
    ...
    <div class="footBtn">
        <button href="index.php" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i> Continue
            Shopping</button>
    </div>
